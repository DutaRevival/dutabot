...
DICTIONNAIRE = set(normalize(w) for w in [
    "ah","ai","an","as","au","ba","be","bi","bo","bu","ca","ce","ci","da","de","du","eh","el","em","en","er","es","et","eu","ex","fa","fi","go","ha","hi","ho","il","in","je","la","le","li","lo","lu","ma","me","mi","mo","mu","na","ne","ni","no","nu","on","or","os","ou","pa","pi","po","pu","ra","re","ri","ro","ru","sa","se","si","so","su","ta","te","ti","to","tu","un","us","va","ve","vi","vo","vu","ya","yo",
    "ab","ad","ag","al","am","ar","at","aw","ax","ay","by","do","ed","ef","go","he","hm","id","if","is","it","jo","ka","ki","mm","my","od","oe","of","oh","oi","ok","om","op","ow","ox","oy","pe","qi","sh","uh","um","up","we","wo","xi","xu","ye",
    "able","acte","aide","aile","aire","ame","ami","amie","amis","ane","ange","anis","arme","as","aube","auto","aveu","axe","bac","bal","ban","bar","bas","beau","bec","bel","bien","bile","bleu","bloc","bois","bol","bon","bord","bout","bras","brin","brun","cage","cal","camp","cane","cap","car","case","cent","char","chat","chef","cher","chic","chou","ciel","cite","clan","clou","club","code","coin","col","cone","cor","cote","coup","cour","crac","cran","cure","dame","dans","date","demi","dent","deux","dire","dome","dose","drap","dune","dure","eau","edit","elan","ente","eros","etat","ete","etre","euro","face","fade","fait","fane","fate","fer","fete","feu","fier","file","film","fils","fine","flan","flip","flot","foie","fond","font","fort","four","gain","gale","gare","gars","gate","gaze","gene","gite","golf","gore","gout","grad","gras","gris","grue","hale","halo","hate","heur","hier","home","hors","hote","ile","inde","iris","jade","jean","joli","joue","jour","juge","jupe","lame","lard","lent","lest","leur","lice","lieu","lime","lire","lobe","loge","loin","lors","loue","loup","lune","mage","male","malt","mare","mars","mast","mate","mere","mine","mode","moue","mort","mule","nard","noel","noir","note","nuit","ocre","once","onde","oral","orge","orme","ours","page","pale","paon","pare","part","pate","pave","peau","pere","pied","pile","pine","pire","plan","plat","plie","plot","pore","port","pose","prat","prix","puce","rade","rale","rame","rang","rape","rare","rase","rate","reel","rein","rent","rice","ride","rire","rite","robe","role","rome","rude","ruse","sang","sans","saut","seau","sere","seve","silo","sole","sort","sous","stop","suer","sure","tare","tele","tend","tenu","tile","tire","toit","tome","tone","tore","tort","trac","tram","trap","tres","trio","trop","tube","tune","type","unit","vale","vane","veau","vent","vers","vide","vile","vine","vite","voie","voir","vole","vote","vrai","zero","zone",
    "able","acid","aged","also","area","army","away","back","ball","band","bank","base","bath","bear","beat","bell","best","bird","bite","blow","blue","boat","body","bold","bolt","bond","bone","book","bore","born","both","bowl","burn","came","camp","cape","card","care","cart","case","cast","cave","cent","char","chat","chin","chip","cite","clad","clam","clan","clap","clip","clod","clog","clot","club","clue","coal","coat","coil","cold","colt","come","cord","core","corn","cost","cram","crop","dart","data","date","deal","dean","dear","debt","deck","deed","deer","deli","dent","diet","dirt","disc","dish","disk","dock","dole","dome","done","door","dorm","dote","down","drag","dram","draw","drip","drop","drum","dual","duel","dune","dupe","dust","earl","earn","east","edge","edit","else","emit","epic","even","ever","evil","exam","face","fact","fail","fair","fall","fame","fang","fare","farm","fast","fate","fear","feat","feel","fell","felt","fend","fern","file","fill","film","find","fine","fire","firm","fist","flag","flat","flaw","flea","fled","flew","flip","flit","flow","foam","fold","folk","fond","food","fool","foot","ford","fore","fork","form","fort","foul","four","free","fuel","full","fume","gain","gale","game","gang","gate","gave","gaze","gear","gent","germ","gild","girl","give","glad","glee","glen","glib","glob","glue","goal","gold","golf","gone","good","gore","gown","grab","grad","gram","gray","grew","grid","grim","grin","grip","grit","grow","gulf","gust","hack","hale","half","hall","halt","hand","hang","hard","hare","harm","harp","hart","hate","have","heal","heap","heat","heel","held","helm","help","here","hero","hide","high","hike","hill","hint","hire","hold","hole","home","hood","hook","hope","horn","host","hour","hulk","hull","hump","hunt","hurt","idea","idle","inch","into","iron","isle","item","jade","jail","jane","jaws","jean","jeer","jibe","jilt","jive","joke","jolt","jump","just","keel","keen","keep","kern","kick","kind","king","knob","knot","lace","lack","lame","lamp","land","lane","lard","lark","lash","last","late","lead","leaf","lean","leap","lend","lens","lest","liar","lice","lick","lied","lies","life","lift","like","lime","limp","line","link","lint","list","live","load","loam","lobe","lock","loft","lone","long","look","loom","lord","lore","lose","lost","loud","love","luck","made","mail","main","make","male","malt","mane","mare","mark","mart","mast","mate","mead","meal","mean","meat","meet","melt","mend","mere","mild","mile","milk","mill","mind","mine","mint","mire","miss","mist","moan","mole","molt","monk","mood","moon","moor","more","mort","most","move","muck","mule","must","nail","name","near","neck","need","next","nice","nick","nine","node","none","noon","norm","nose","note","null","oath","odds","once","open","oral","orca","oven","over","pace","pack","page","paid","pain","pair","pale","palm","pane","park","part","past","path","peak","peel","peer","pelt","pick","pier","pile","pine","pink","pipe","plan","play","plod","plot","plow","plum","plus","poem","poet","pole","poll","pond","pore","port","pose","post","pour","prey","prod","prop","pull","pump","pure","push","race","rack","raid","rail","rain","rake","ramp","rang","rank","rant","rapt","rate","read","real","reap","reel","rein","rely","rend","rent","rest","rice","rich","ride","rift","ring","riot","rise","risk","road","roam","roar","robe","rock","rode","role","roll","roof","room","root","rope","rose","rout","rude","ruin","rule","rump","rune","ruse","rush","rust","safe","sail","sake","sale","salt","same","sand","sane","sang","sank","sate","save","scan","scar","seal","seam","sear","seat","self","send","shed","shin","ship","shoe","shop","shot","shun","shut","sick","side","sift","sign","silk","silo","silt","sing","sink","site","size","skid","skim","skin","skip","slab","slap","slat","slim","slip","slob","slop","slot","slum","slur","snag","snap","snob","snot","snow","soak","soar","sock","soil","sold","sole","some","song","soot","sore","sort","soul","soup","sour","span","spar","spin","spit","spot","spur","stab","stag","star","stay","stem","step","stir","stop","stub","stun","suck","suit","sulk","sung","sunk","sure","surf","swam","swan","swap","sway","swim","tail","tale","talk","tall","tame","tang","tank","tare","tart","teal","team","tear","teem","tell","tend","tent","term","thin","tide","tile","till","time","tire","toad","toil","told","toll","tome","tone","tong","tool","torn","toss","tour","town","trap","tray","tree","trim","trip","trod","true","tube","tuck","tuft","tune","tusk","twin","type","undo","upon","urge","used","vale","vane","vast","veil","vein","vent","verb","very","vest","vial","vice","view","vile","vine","void","volt","wade","wage","wail","wake","walk","wall","wand","wane","ward","ware","warm","warn","warp","wart","wash","wave","weak","weal","wean","wear","weed","weld","went","west","wide","wild","will","wilt","wind","wine","wing","wink","wire","wise","wish","wisp","woke","wold","womb","wood","wool","word","wore","work","worm","worn","wrap","wren","yell","zeal","zero","zinc","zone","zoom",
    "grand","grand","grande","grandi","grade","grade","graine","grain","trop","trop","trop","pole","poles","poil","poile","goat","goats","plant","plante","plante","pilote","pilot","pilot","litre","litre","notre","noter","noret","noter","point","poing","ronde","tonde","tondre","ligne","linge","large","largo","lapin","lapins","tornade","doigt","doigts","doigt","gilet","gilet","garde","garder","gardet","gardon","pardon","pareil","paroi","patrol","patrons","patron","prison","prion","cargot","carton","cartons","cargo","cargo","agile","agiles","agiter","gilet","gilets","pilote","dragon","dragons","draper","drape","drapes","pelage","pelagos","polaire","polaire","loger","logent","logera","adopter","adopte","adoptes","anoder","anode","anodes","argent","argents","argile","argiles","nageoire","nageoires","orange","oranges","rapport","rapports","rapide","rapides","randonne","randonnee","planete","planetes",
])

def is_valid_word(word):
    return normalize(word) in DICTIONNAIRE
...
ALL_QUIZ_QUESTIONS = [
    {"q": "Quelle est la capitale de la France ?", "a": "paris", "choices": ["Madrid", "Paris", "Rome"]},
    {"q": "Combien de joueurs dans une equipe de foot ?", "a": "11", "choices": ["9", "11", "13"]},
    {"q": "Quel pays a remporte la Coupe du Monde 2018 ?", "a": "france", "choices": ["France", "Allemagne", "Bresil"]},
    {"q": "Quelle planete est la plus proche du soleil ?", "a": "mercure", "choices": ["Venus", "Mercure", "Mars"]},
    {"q": "Combien de continents sur Terre ?", "a": "7", "choices": ["5", "6", "7"]},
    {"q": "Quelle est la plus grande planete ?", "a": "jupiter", "choices": ["Saturne", "Jupiter", "Neptune"]},
    {"q": "Premiere Coupe du Monde de foot ?", "a": "1930", "choices": ["1926", "1930", "1934"]},
    {"q": "Quel est l animal le plus rapide ?", "a": "guepard", "choices": ["Lion", "Guepard", "Aigle"]},
    {"q": "Combien de cordes sur une guitare classique ?", "a": "6", "choices": ["4", "6", "8"]},
    {"q": "Quel est le plus grand pays du monde ?", "a": "russie", "choices": ["Canada", "Chine", "Russie"]},
    ...
    {"q": "Capitale du Bresil ?", "a": "brasilia", "choices": ["Sao Paulo", "Rio de Janeiro", "Brasilia"]},
    {"q": "Quel pays a gagne la Coupe du Monde 2022 ?", "a": "argentine", "choices": ["France", "Argentine", "Bresil"]},
    {"q": "Combien de joueurs dans une equipe de basket ?", "a": "5", "choices": ["5", "6", "7"]},
    ...
    {"q": "Quel pays a gagne la Coupe du Monde 2014 ?", "a": "allemagne", "choices": ["Allemagne", "Argentine", "Bresil"]},
    {"q": "Combien de minutes dans un match de foot ?", "a": "90", "choices": ["80", "90", "120"]},
    {"q": "Capitale du Maroc ?", "a": "rabat", "choices": ["Casablanca", "Marrakech", "Rabat"]},
    {"q": "Capitale du Ghana ?", "a": "accra", "choices": ["Kumasi", "Accra", "Tamale"]},
    {"q": "Quel pays a gagne la Coupe du Monde 2010 ?", "a": "espagne", "choices": ["Espagne", "Pays-Bas", "Allemagne"]},
    {"q": "Qui a invente le telephone ?", "a": "graham bell", "choices": ["Thomas Edison", "Graham Bell", "Nikola Tesla"]},
    {"q": "Capitale du Japon ?", "a": "tokyo", "choices": ["Osaka", "Tokyo", "Kyoto"]},
    {"q": "Combien d os dans le corps humain ?", "a": "206", "choices": ["186", "206", "256"]},
    ...
    {"q": "Combien de secondes dans une heure ?", "a": "3600", "choices": ["3000", "3600", "6000"]},
    {"q": "Plus grand desert du monde ?", "a": "sahara", "choices": ["Kalahari", "Sahara", "Gobi"]},
    {"q": "Combien de couleurs dans l arc en ciel ?", "a": "7", "choices": ["5", "6", "7"]},
    {"q": "Plus grand pays d Afrique ?", "a": "algerie", "choices": ["Soudan", "Algerie", "RDC"]},
    {"q": "Combien de joueurs dans une equipe de rugby ?", "a": "15", "choices": ["13", "15", "17"]},
    {"q": "Qui a peint la Joconde ?", "a": "leonard de vinci", "choices": ["Michel-Ange", "Leonard de Vinci", "Raphael"]},
    {"q": "Combien de planetes dans le systeme solaire ?", "a": "8", "choices": ["7", "8", "9"]},
    ...
    {"q": "Pays avec la plus grande population ?", "a": "inde", "choices": ["Chine", "Inde", "USA"]},
    ...
    {"q": "En quelle annee Facebook a ete cree ?", "a": "2004", "choices": ["2002", "2004", "2006"]},
    {"q": "Qui a fonde Apple ?", "a": "steve jobs", "choices": ["Bill Gates", "Steve Jobs", "Mark Zuckerberg"]},
    {"q": "Annee du lancement du premier iPhone ?", "a": "2007", "choices": ["2005", "2007", "2009"]},
    {"q": "Dans quel pays est ne Cristiano Ronaldo ?", "a": "portugal", "choices": ["Espagne", "Bresil", "Portugal"]},
    {"q": "Dans quel pays est ne Lionel Messi ?", "a": "argentine", "choices": ["Argentine", "Uruguay", "Chili"]},
    {"q": "Plus long fleuve d Afrique ?", "a": "nil", "choices": ["Congo", "Nil", "Niger"]},
    {"q": "Combien de grammes dans un kilogramme ?", "a": "1000", "choices": ["500", "1000", "1500"]},
    {"q": "Combien de metres dans un kilometre ?", "a": "1000", "choices": ["100", "1000", "10000"]},
    {"q": "Qui detient le record du monde du 100m ?", "a": "usain bolt", "choices": ["Usain Bolt", "Tyson Gay", "Asafa Powell"]},
    {"q": "Dans quel pays se trouve la Tour Eiffel ?", "a": "france", "choices": ["Belgique", "Suisse", "France"]},
    {"q": "Dans quel pays se trouve le Colisee ?", "a": "italie", "choices": ["Grece", "Italie", "Espagne"]},
    {"q": "Plus grande montagne d Afrique ?", "a": "kilimandjaro", "choices": ["Mont Kenya", "Kilimandjaro", "Mont Cameroun"]},
    {"q": "Annee debut de la Premiere Guerre Mondiale ?", "a": "1914", "choices": ["1912", "1914", "1916"]},
    {"q": "Quel pays a invente le football ?", "a": "angleterre", "choices": ["France", "Angleterre", "Ecosse"]},
    {"q": "Combien de joueurs dans une equipe de handball ?", "a": "7", "choices": ["5", "7", "9"]},
    {"q": "Capitale de l Egypte ?", "a": "le caire", "choices": ["Alexandrie", "Le Caire", "Louxor"]},
    {"q": "Quel est l os le plus long du corps ?", "a": "femur", "choices": ["Tibia", "Femur", "Humerus"]},
    {"q": "Quel animal a le plus long cou ?", "a": "girafe", "choices": ["Elephant", "Chameau", "Girafe"]},
    {"q": "Seul mammifere qui peut voler ?", "a": "chauve souris", "choices": ["Ecureuil volant", "Chauve Souris", "Lemur"]},
    {"q": "Monnaie de l Europe ?", "a": "euro", "choices": ["Franc", "Euro", "Mark"]},
    {"q": "Combien de dents a un adulte ?", "a": "32", "choices": ["28", "30", "32"]},
    {"q": "En quelle annee l homme a marche sur la lune ?", "a": "1969", "choices": ["1965", "1969", "1972"]},
    {"q": "Qui a invente l ampoule electrique ?", "a": "thomas edison", "choices": ["Nikola Tesla", "Thomas Edison", "Benjamin Franklin"]},
    {"q": "Combien de faces a un cube ?", "a": "6", "choices": ["4", "6", "8"]},
    {"q": "Combien de joueurs dans une equipe de volleyball ?", "a": "6", "choices": ["5", "6", "7"]},
    {"q": "Capitale de l Italie ?", "a": "rome", "choices": ["Milan", "Naples", "Rome"]},
    {"q": "Capitale du Portugal ?", "a": "lisbonne", "choices": ["Porto", "Lisbonne", "Faro"]},
    {"q": "Quel pays a gagne la Coupe du Monde 2006 ?", "a": "italie", "choices": ["France", "Italie", "Allemagne"]},
    {"q": "Quel pays a gagne la Coupe du Monde 2002 ?", "a": "bresil", "choices": ["Bresil", "Allemagne", "Coree du Sud"]},
    ...
    {"q": "Combien de zeros dans un million ?", "a": "6", "choices": ["5", "6", "7"]},
    {"q": "Vitesse de la lumiere en km/s ?", "a": "300000", "choices": ["150000", "300000", "600000"]},
    {"q": "Combien de minutes dans une journee ?", "a": "1440", "choices": ["1000", "1440", "2400"]},
    {"q": "Element chimique de l eau ?", "a": "h2o", "choices": ["CO2", "H2O", "O2"]},
    {"q": "Plus grand lac du monde ?", "a": "mer caspienne", "choices": ["Lac Superieur", "Mer Caspienne", "Lac Victoria"]},
    {"q": "Combien d etoiles sur le drapeau americain ?", "a": "50", "choices": ["48", "50", "52"]},
    {"q": "Qui a compose la 5eme symphonie ?", "a": "beethoven", "choices": ["Mozart", "Beethoven", "Bach"]},
    {"q": "Dans quel pays se trouve le Machu Picchu ?", "a": "perou", "choices": ["Bolivie", "Colombie", "Perou"]},
    {"q": "Combien de jours dans une annee bissextile ?", "a": "366", "choices": ["364", "365", "366"]},
    {"q": "Quel est le sport le plus populaire au monde ?", "a": "football", "choices": ["Basketball", "Football", "Tennis"]},
    ...
    {"q": "Combien de grammes dans une tonne ?", "a": "1000000", "choices": ["100000", "1000000", "10000000"]},
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "/quiz - QCM avec 3 choix de reponse\n"
        "/score - Votre score\n"
...
async def jumble(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id in jumble_sessions and jumble_sessions[user_id].get("active"):
        await update.message.reply_text("Vous avez deja une partie en cours! Continuez a taper des mots!")
        return
    ...
    context.job_queue.run_once(
        ...
        name=f"jumble_{user_id}"
    )

async def jumble_end(context: ContextTypes.DEFAULT_TYPE):
    job = context.job
    user_id = job.data["user_id"]
    chat_id = job.data["chat_id"]

    if user_id not in jumble_sessions:
        return
...
async def quiz(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id in quiz_sessions and quiz_sessions[user_id].get("active"):
        await update.message.reply_text("Vous avez deja une question en cours! Cliquez sur une reponse!")
        return
    ...
    keyboard = [[InlineKeyboardButton(c, callback_data=f"quiz_{user_id}_{normalize(c)}")] for c in choices]
    await update.message.reply_text(
    ...
    context.job_queue.run_once(
        quiz_end,
        30,
        data={"user_id": user_id, "chat_id": chat_id, "answer": question["a"]},
        name=f"quiz_{user_id}"
    )

async def quiz_end(context: ContextTypes.DEFAULT_TYPE):
    job = context.job
    user_id = job.data["user_id"]
    chat_id = job.data["chat_id"]
...
async def quiz_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if target_user_id not in quiz_sessions or not quiz_sessions[target_user_id].get("active"):
        await query.edit_message_text("Cette question a expire. /quiz pour continuer!")
        return
    ...
    # Annuler le timer
    jobs = context.job_queue.get_jobs_by_name(f"quiz_{target_user_id}")
    for job in jobs:
    ...
    if chosen == correct:
        ...
        await query.edit_message_text(
            f"❌ Mauvaise reponse!\nLa bonne reponse etait: {correct.upper()}\n\n/quiz pour continuer!"
        )
...
async def foot_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await query.edit_message_text(f"Recherche en cours pour {league_name}...")
